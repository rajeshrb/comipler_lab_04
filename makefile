all: lex.cc parse.cc main.cc Scanner.h Scannerbase.h Scanner.ih Parser.h Parserbase.h Parser.ih 
	./sedscript
	@sed -i '/#include "Parser.h"/a string type_s = "default";int enable = 1;_Function * _curr;unordered_map<string,_Function*> Functions; extern int no_lines;int err=0;string _vtype;int _dima=0;int _posp=0;int g_off=0;program *_prog;' Parser.ih;
